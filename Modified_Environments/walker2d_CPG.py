...
class Walker2dCPGEnv(MujocoEnv, utils.EzPickle):
    """
    ## Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.terminated_rewards = terminated_reward
        ...
        num_oscillators = 2
        neuron_number = 2
        da = 6  # neuron_number * num_oscillators
        ...
        self.matsuoka_network = MatsuokaNetworkWithNN(num_oscillators=num_oscillators,
                                                      env=[observation_space, da], n_envs=1,
                                                      neuron_number=neuron_number, tau_r=2,
                                                      tau_a=12)
    ...
    def set_rewards(self, forward_rewards=1.0, ctrl_cost_rewards=1e-3, healthy_rewards=1.0):
        self._forward_reward_weight = forward_rewards
        self._ctrl_cost_weight = ctrl_cost_rewards
        self._healthy_reward = healthy_rewards
    ...
    def terminated(self):
        ...
        if terminated:
            terminated_reward = self.terminated_rewards
        else:
            terminated_reward = 0.0
        return terminated, terminated_reward
    ...
    def step(self, params):
        ...
        terminated, terminated_reward = self.terminated
